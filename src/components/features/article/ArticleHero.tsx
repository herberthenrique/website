    ...
    <div className="flex flex-col overflow-hidden rounded-2xl border border-gray300 shadow-lg lg:flex-row-reverse">
      ...
      <div className="relative flex flex-1 basis-1/2 flex-col justify-center py-6 px-4 lg:px-16 lg:py-12 xl:px-24">
        <div className="mb-2 flex flex-wrap items-center">
          ...
          {isFeatured && (
            <ArticleLabel className="ml-auto hidden pl-2 lg:absolute lg:top-8 lg:left-6 xl:top-12 xl:left-12">
              {t('article.featured')}
            </ArticleLabel>
          )}
          <div
            className="ml-auto hidden pl-2 text-xs text-gray600 lg:block"
        ...
        <div
          className="mt-2 text-xs text-gray600 lg:hidden"
          {...inspectorProps({ fieldId: 'publishedDate' })}
        >
          <FormatDate date={publishedDate} />
        </div>
